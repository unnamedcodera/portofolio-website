...
router.post('/', verifyCsrfToken, authMiddleware, teamValidation, validateRequest, (req, res) => {
  try {
...
router.put('/:id', verifyCsrfToken, authMiddleware, teamValidation, validateRequest, (req, res) => {
  try {
...
router.delete('/:id', verifyCsrfToken, authMiddleware, (req, res) => {
  try {
