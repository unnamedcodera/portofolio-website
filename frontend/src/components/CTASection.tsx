        ...
        {showModal && (
          ...
          >
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-vandyke via-walnut to-vandyke text-white p-4 sm:p-6 md:p-8 overflow-hidden">
                ...
                <div className="relative z-10 flex items-start sm:items-center justify-between mb-4 sm:mb-6 gap-2">
                  <div className="flex items-center gap-2 sm:gap-4 flex-1 min-w-0">
                    {/* Logo Badge */}
                    <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl sm:rounded-2xl bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/20 shadow-lg flex-shrink-0">
                      <img src="/img/DH.png" alt="DH" className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 object-contain" />
                    </div>
                    <div className="min-w-0 flex-1">
                      <h3 className="text-base sm:text-xl md:text-2xl font-black mb-1 tracking-tight truncate">Darahitam Creative Lab</h3>
                      <div className="flex items-center gap-1.5 sm:gap-2 text-white/90 text-xs sm:text-sm flex-wrap">
                        <div className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-0.5 sm:py-1 bg-white/10 rounded-full backdrop-blur-sm border border-white/20">
                          <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                          </svg>
                          <span className="font-semibold whitespace-nowrap">Step {currentStep} of 3</span>
                        </div>
                        <span className="text-white/70 hidden sm:inline">•</span>
                        <span className="text-white/90 font-medium hidden sm:inline whitespace-nowrap">Easy & Quick</span>
                      </div>
                    </div>
                  </div>
                  <button
                    onClick={() => setShowModal(false)}
                    className="p-2 sm:p-2.5 hover:bg-white/20 rounded-xl transition-all hover:scale-110 hover:rotate-90 duration-300 flex-shrink-0"
                  >
