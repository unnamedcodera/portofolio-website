...
const ArtisticFrameSlider: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[400px] sm:h-[450px] md:h-[550px] flex items-center justify-between gap-2 sm:gap-3 md:gap-4 lg:gap-6 max-w-7xl mx-auto px-2 sm:px-0 overflow-visible">
        
        {/* LEFT PREVIEW - Previous Slide (Partially visible on mobile) */}
        <motion.div
          className="relative w-16 sm:w-24 md:w-40 lg:w-48 flex-shrink-0 -ml-6 sm:-ml-8 md:ml-0"
        ...
        {/* RIGHT PREVIEW - Next Slide (Partially visible on mobile) */}
        <motion.div
          className="relative w-16 sm:w-24 md:w-40 lg:w-48 flex-shrink-0 -mr-6 sm:-mr-8 md:mr-0"
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8, delay: 0.3 }}
          whileHover={{ scale: 1.08 }}
