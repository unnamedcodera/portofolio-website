...
const ProjectDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-magnolia">
      <SEO 
        title={project.title}
        description={project.description || `Discover ${project.title} by Darahitam Creative Lab. Professional creative solutions and design services.`}
        image={project.banner_image || project.image_url}
        url={`https://darahitam.com/projects/${slug}`}
        type="article"
        keywords={`${project.title}, ${project.category}, creative project, design, darahitam`}
      />
